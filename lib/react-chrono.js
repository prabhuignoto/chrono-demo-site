...
var TimelineControl = React__default['default'].memo(function (ref) {
  ...
  return React__default['default'].createElement(TimelineControlContainer, {
  ...
  }, React__default['default'].createElement(TimelineNavWrapper, null, React__default['default'].createElement(TimelineNavItem, {
    disable: disableLeft
    ...
    title: "Go to First",
    "aria-label": "first"
  }, React__default['default'].createElement(_default$3, null))), React__default['default'].createElement(TimelineNavItem, {
    disable: disableLeft
  }, React__default['default'].createElement(TimelineNavButton, {
    mode: mode,
    theme: theme,
    ...
    title: "Previous",
    "aria-label": "previous"
  }, React__default['default'].createElement(_default$1, null))), React__default['default'].createElement(TimelineNavItem, {
    ...
    title: "Next",
    "aria-label": "next"
  }, React__default['default'].createElement(_default$2, null))), React__default['default'].createElement(TimelineNavItem, {
    disable: disableRight
  }, React__default['default'].createElement(TimelineNavButton, {
    mode: mode,
    theme: theme,
    ...
    title: "Go to Last",
    "aria-label": "last"
  }, React__default['default'].createElement(_default$4, null))), React__default['default'].createElement(TimelineNavItem, null, slideShowEnabled && React__default['default'].createElement(ReplayWrapper, {
    theme: theme,
    onClick: onReplay,
    title: "Play Slideshow"
  }, React__default['default'].createElement(_default$5, null)))));
});
...
var CardMedia = function (ref) {
  ...
  return React__default['default'].createElement(MediaWrapper, {
    theme: theme,
    active: active,
    mode: mode,
...
var TimelineItemContent = function (ref) {
  ...
  var canShowMore = React.useRef(!!detailedText);
  ...
  return React__default['default'].createElement(TimelineItemContentWrapper, {
    ...
    content: content
  }), media && React__default['default'].createElement(_default$7, {
    media: media,
    content: content,
    title: title,
    mode: mode,
    ...
    theme: theme
  }, detailedText && !media && React__default['default'].createElement(TimelineContentDetails, {
    className: showMore ? "active" : ""
  }, detailedText)), !media && React__default['default'].createElement(ShowMore, {
    role: "button",
    onClick: function () {
...
var TimelineItem = function (ref) {
  ...
  var timelineContent = function () {
    ...
    }, React__default['default'].createElement(_default$9, {
      title: title,
      active: active,
      theme: theme
    })), React__default['default'].createElement(_default$8, {
      content: contentText,
      active: active,
      title: contentTitle,
...
var TimelineCollection = function (ref) {
  ...
  }, React__default['default'].createElement(_default$a, Object.assign({}, item, {
...
var TreeBranch = function (props) {
  ...
  return React__default['default'].createElement(Branch, {
    className: `${className} ${visible ? "visible" : ""} branch-main`,
    key: index,
    ref: contentRef,
    "data-testid": "branch-main",
    alternateCards: alternateCards
  }, React__default['default'].createElement(TimelineTreeTitleWrapper, {
    className: className,
    alternateCards: alternateCards
  }, React__default['default'].createElement(_default$9, {
    title: title,
  ...
  })), React__default['default'].createElement(_default$c, {
    className: className,
    id: id,
    active: active,
    onClick: onClick,
...
var TimelineTree = function (ref) {
  ...
  return React__default['default'].createElement(TimelineTreeWrapper, {
    ...
    return React__default['default'].createElement(_default$d, {
      className: className,
      id: item.id,
      index: index,
      onClick: onClick,
...
var Timeline = function (props) {
  ...
  var timelineMainRef = React.useRef(null); // generate a unique id for the timeline content
  ...
  return React__default['default'].createElement(Wrapper$1, {
    ...
    ref: timelineMainRef,
    className: mode.toLowerCase()
  }, mode === "TREE" ? React__default['default'].createElement(_default$e, {
    items: items,
  ...
  }), React__default['default'].createElement(_default$b, {
    items: items,
    itemWidth: itemWidth,
    ...
    slideItemDuration: slideItemDuration,
    onElapsed: function (id) { return handleTimelineItemClick(id, true); }
  })) : null, mode === "VERTICAL" ? React__default['default'].createElement(_default$e, {
    items: items,
    onClick: handleTimelineItemClick,
    activeTimelineItem: activeTimelineItem,
    autoScroll: handleScroll,
    ...
    mode: mode
  }, React__default['default'].createElement(_default$6, {
    onNext: handleNext,
...
var Chrono = function (ref) {
  ...
  return React__default['default'].createElement(_default$f, {
    activeTimelineItem: activeTimelineItem,
